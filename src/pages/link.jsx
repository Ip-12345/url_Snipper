    ...
    <>
      ...
      <div className='flex flex-col gap-8 sm:flex-row justify-between'>
        <div className='flex flex-col gap-8 items-start rounded-lg sm:w-2/5'>
          ...
          <a href={`https://urlSnipper.in/{link}`} target='_blank' className='text-3xl sm:text-4xl text-blue-400 font-bold hover:underline cursor-pointer'>
            https://urlSnipper.in/{link}</a>
        ...
        <Card className='sm:w-3/5'>
          <CardHeader className='text-4xl font-extrabold'>
